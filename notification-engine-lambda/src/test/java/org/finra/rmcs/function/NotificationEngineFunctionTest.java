...
@SpringJUnitConfig
class NotificationEngineFunctionTest {

  private static final ObjectMapper mapper = new ObjectMapper();
  SQSEvent dryRunSqsEvent;
  @InjectMocks
  private NotificationEngineFunction notificationEngineFunction;
  @Mock
  ...
  void apply_dryRunTest() {
    Map<String, Object> actual = notificationEngineFunction.apply(dryRunSqsEvent);
  ...
  void apply_validMessageTest() throws IOException {
    ...
    Mockito.doNothing().when(emailService).sendEmailNotification(notificationMessage);
    Map<String, Object> actual = notificationEngineFunction.apply(sqsEvent);

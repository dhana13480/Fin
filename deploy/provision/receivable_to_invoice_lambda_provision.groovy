...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "receivable-to-invoice-lambda"
}
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/receivable-to-invoice-lambda"
                deployArchive = "rmcs-receivable-to-invoice-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Receivable-To-Invoice-Lambda-${envMap["sdlcUpper"]}"

...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "batchfile-process-dm-receivable-file-lambda"
}
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/batchfile-process-dm-receivable-file-lambda"
                deployArchive = "rmcs-batchfile-process-dm-receivable-file-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Batchfile-Process-DM-Receivable-File-Lambda-${envMap["sdlcUpper"]}"

...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "batchfile-process-response-lambda"
}
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/batchfile-process-response-lambda"
                deployArchive = "rmcs-batchfile-process-response-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Batchfile-Process-Response-Lambda-${envMap["sdlcUpper"]}"

...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "send-invoice-to-wd-lambda"
}
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/send-invoice-to-wd-lambda"
                deployArchive = "rmcs-send-invoice-to-wd-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Send-Invoice-To-WD-Lambda-${envMap["sdlcUpper"]}"

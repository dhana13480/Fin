...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "batchfile-process-receivable-lambda"
}
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/batchfile-process-receivable-lambda"
                deployArchive = "rmcs-batchfile-process-receivable-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Batchfile-Process-Receivable-Lambda-${envMap["sdlcUpper"]}"

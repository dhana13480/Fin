...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "batchfile-process-file-in-chunks-lambda"
}
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/batchfile-process-file-in-chunks-lambda"
                deployArchive = "rmcs-batchfile-process-file-in-chunks-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Batchfile-Process-File-In-Chunks-Lambda-${envMap["sdlcUpper"]}"

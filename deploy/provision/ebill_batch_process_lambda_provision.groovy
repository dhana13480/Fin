...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "ebill-batch-process-lambda"
}
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/ebill-batch-process-lambda"
                deployArchive = "rmcs-ebill-batch-process-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Ebill-Batch-Process-Lambda-${envMap["sdlcUpper"]}"

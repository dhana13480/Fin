...
tags {
    ...
    costCenter = "RSM302"
    sdlc = "${sdlc}"
    component = "ebill-accounting-equation-report-lambda"
}
...
lambdas {
    global_configuration {
        ...
        subscriptionFilter {
            deliveryStreamName = "SPLUNK-LAMBDA-RMCS"
    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/ebill-accounting-equation-report-lambda"
                deployArchive = "rmcs-ebill-accounting-equation-report-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-Ebill-Accounting-Equation-Report-Lambda-${envMap["sdlcUpper"]}"
            ...
            vpcConfig {
           	...
           	eventSource {
                type = "SQS"
                sqsName = "ESMP-X-${envMap["esmpQueueSdlc"]}-${ags}-EBILL-ACCOUNTEQUATION_TRIGGER${envMap["queueNameSuffix"]}_QUEUE"
                batchSize = "1"
            }

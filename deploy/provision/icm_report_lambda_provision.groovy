    ...
    lambdas {
        lambda1 {
            staging {
                ...
                prefix = "RMCS/icm-report-lambda"
                deployArchive = "rmcs-icm-report-lambda-${rmcsbuildnumber}.jar"
                generateUniqueLocation = false
            }

            name = "RMCS-ICM-Report-Lambda-${envMap["sdlcUpper"]}"

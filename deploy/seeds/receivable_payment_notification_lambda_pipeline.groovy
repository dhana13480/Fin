...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "receivable-payment-notification-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("receivable-payment-notification-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("receivable_payment_notification_lambda_provision.groovy"),
                ])
                .withDryRun(false)
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("receivable_payment_notification_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Receivable-Payment-Notification-Lambda")
                ])
        ...
        switch(sdlc) {
            case 'qa':
            case 'qaint':
                job.withDownstream(corpSysToInvoiceQA())
                break
        }
    ...
    private JenkinsJob corpSysToInvoiceQA() {
        JenkinsJob.newInstance()

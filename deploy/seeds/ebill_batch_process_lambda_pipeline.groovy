...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "ebill-batch-process-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("ebill-batch-process-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("ebill_batch_process_lambda_provision.groovy")
                ])
                .withDryRun(false)
                ...
                .withSonarQube([
                        SonarQube.newInstance()
                                ...
                                .withProperties("sonar.projectKey=org.finra."+ Constants.AGS.toLowerCase() + ":" + COMPONENT + " \n" +
                                        ...
                                        "sonar.coverage.exclusions=**/test/**/*.*, **/dto/*.*,**/domain/*.*,**/exception/*.*, **/entity/*.*, **/constants/*.*, **/config/**/*.*, **/model/**/*.*, **/EbillBatchProcessLambdaApplication.java \n" +
                                        "sonar.exclusions=**/test/**/*.*, **/dto/*.*,**/domain/*.*,**/exception/*.*, **/entity/*.*, **/constants/*.*, **/config/**/*.*, **/model/**/*.*,**/exception/**/*.*, **/EbillBatchProcessLambdaApplication.java \n" +
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("ebill_batch_process_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Ebill-Batch-Process-Lambda")
                ])

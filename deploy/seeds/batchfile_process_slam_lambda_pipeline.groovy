...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "batchfile-slam-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("batchfile-slam-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_slam_lambda_provision.groovy"),
                ])
                .withDryRun(false)
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_slam_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Batchfile-Slam-Lambda")

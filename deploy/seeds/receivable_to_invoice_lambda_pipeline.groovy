...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "receivable-to-invoice-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("receivable-to-invoice-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("receivable_to_invoice_lambda_provision.groovy"),
                ])
                .withDryRun(false)
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("receivable_to_invoice_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Receivable-To-Invoice-Lambda")
                ])

...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "receivable-item-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("receivable-item-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("receivable_item_lambda_provision.groovy"),
                ])
                .withDryRun(false)
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("receivable_item_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Receivable-Item-Lambda")
        ...
        switch(sdlc) {
            case 'qa':
            case "qaint":
                job.withDownstream(corpSysReceivableItemQA())
                break
        }
    ...
    private JenkinsJob corpSysReceivableItemQA() {
        JenkinsJob.newInstance()

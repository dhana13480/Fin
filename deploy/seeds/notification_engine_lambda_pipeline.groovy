...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "notification-engine-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("notification-engine-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("notification_engine_lambda_provision.groovy"),
                ])
                .withDryRun(false)
                ...
                .withSonarQube([
                        SonarQube.newInstance()
                                ...
                                .withProperties("sonar.projectKey=org.finra."+ Constants.AGS.toLowerCase() + ":" + COMPONENT + " \n" +
                                        ...
                                        "sonar.coverage.exclusions=**/test/**/*.*, **/dto/*.*, **/entity/*.*,**/exception/*.*, **/constants/*.*, **/repo/*.*,**/config/**/*.*, **/model/**/*.*, **/RmcsNotificationEngineLambdaApplication.java \n" +
                                        "sonar.exclusions=**/test/**/*.*, **/dto/*.*, **/entity/*.*, **/constants/*.*, **/config/**/*.*, **/model/**/*.*,**/repo/*.*,**/exception/**/*.*, **/RmcsNotificationEngineApplication.java \n" +
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("notification_engine_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Notification-Engine-Lambda")

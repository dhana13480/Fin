...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "batchfile-process-dm-receivable-file-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("batchfile-process-dm-receivable-file-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_process_dm_receivable_file_lambda_provision.groovy")
                ])
                .withDryRun(false)
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_process_dm_receivable_file_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Batchfile-Process-DM-Receivable-File-Lambda")
                ])
        ...
        switch(sdlc) {
            case 'qa':
            case 'qaint':
                job.withDownstream(corpSysProcessDMItemQA())
                break
        }
    ...
    private JenkinsJob corpSysProcessDMItemQA() {
        JenkinsJob.newInstance()

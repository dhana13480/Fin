...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "batchfile-process-response-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("batchfile-process-response-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_process_response_lambda_provision.groovy"),
                ])
                .withDryRun(false)
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_process_response_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Batchfile-Process-Response-Lambda")
        ...
        switch(sdlc) {
            case 'qa':
            case 'qaint':
                job.withDownstream(corpSysBatchfileResponseQA())
                break
        }
    ...
    private JenkinsJob corpSysBatchfileResponseQA() {
        JenkinsJob.newInstance()

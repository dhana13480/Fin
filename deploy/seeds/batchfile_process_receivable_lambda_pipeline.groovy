...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "batchfile-process-receivable-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("batchfile-process-receivable-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_process_receivable_lambda_provision.groovy"),
                ])
                .withDryRun(false)
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("batchfile_process_receivable_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Batchfile-Process-Receivable-Lambda")
        ...
        switch(sdlc) {
            case 'qa':
            case 'qaint':
                job.withDownstream(corpSysBatchFileReceivableItemQA())
                break
        }
    ...
    private JenkinsJob corpSysBatchFileReceivableItemQA() {
        JenkinsJob.newInstance()
                ...
                .withInputChoiceParam([
                        ...
                        InputChoiceParam.newInstance()
                                .withKey("TESTTYPE")
                                .withValue(["BATCHFILECREATERECEIVABLES"])

...
class Lambda extends CommonImpl {
    ...
    private static COMPONENT = "ebill-modeled-schedule-wrapper-lambda"
    ...
    JenkinsJob start() {
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_PATH").withValue("ebill-modeled-schedule-wrapper-lambda"),
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("ebill_modeled_schedule_wrapper_lambda_provision.groovy")
                ])
                .withDryRun(false)
                ...
                .withSonarQube([
                        SonarQube.newInstance()
                                ...
                                .withProperties("sonar.projectKey=org.finra."+ Constants.AGS.toLowerCase() + ":" + COMPONENT + " \n" +
                                        ...
                                        "sonar.coverage.exclusions=**/test/**/*.*, **/dto/*.*,**/domain/*.*,**/exception/*.*, **/entity/*.*, **/constants/*.*, **/config/**/*.*, **/model/**/*.*, **/EbillModeledScheduleWrapperLambdaApplication.java \n" +
                                        "sonar.exclusions=**/test/**/*.*, **/dto/*.*,**/domain/*.*,**/exception/*.*, **/entity/*.*, **/constants/*.*, **/config/**/*.*, **/model/**/*.*,**/exception/**/*.*, **/EbillModeledScheduleWrapperLambdaApplication.java \n" +
    ...
    private JenkinsJob deploy(String sdlc) {
        JenkinsJob job = JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars([
                        AdditionalEnvVars.newInstance().withKey("APP_GROOVY").withValue("ebill_modeled_schedule_wrapper_lambda_provision.groovy"),
                        AdditionalEnvVars.newInstance().withKey("LAMBDA_NAME").withValue("RMCS-Ebill-Modeled-Schedule-Wrapper-Lambda")
                ])
        ...
        JenkinsJob.newInstance()
                ...
                .withAdditionalEnvVars(
                        [AdditionalEnvVars.newInstance()
                                 .withKey("JDK_17_HOME")
                                 .withValue("/usr/lib/jvm/java-17-amazon-corretto"),
                         AdditionalEnvVars.newInstance()
                                 .withKey("JAVA_HOME")

...
@EnableJpaRepositories(
    basePackages = {Constants.ORG_FINRA_RMCS_REPO},
...
public class JpaConfig {
  ...
  public class DataSourceConfiguration {
    ...
    public DataSource dataSource() {
      ...
      String credPassword = fideliusClient.getCredential(
          key, Constants.RMCS, System.getenv(Constants.SPRING_PROFILES_ACTIVE), "", null);
  ...
  public class EntityManagerFactoryConfiguration {
    ...
    final Properties additionalProperties() {
      ...
      hibernateProperties.put(
          Constants.HIBERNATE_CACHE_USE_SECOND_LEVEL_CACHE, Constants.HIBERNATE_FLAG_FALSE);
      hibernateProperties.put(Constants.HIBERNATE_SHOW_SQL, Constants.HIBERNATE_FLAG_FALSE);
      hibernateProperties.put(Constants.HIBERNATE_FORMAT_SQL, Constants.HIBERNATE_FLAG_FALSE);
      hibernateProperties.put(Constants.HIBERNATE_JDBC_BATCH_SIZE, hibernateBatchSize);
      hibernateProperties.put(Constants.HIBERNATE_ORDER_INSERTS, Constants.HIBERNATE_FLAG_TRUE);
      hibernateProperties.put(Constants.HIBERNATE_ENABLE_LAZY_LOAD_NO_TRANS,
          Constants.HIBERNATE_FLAG_TRUE);
      hibernateProperties.put(
          Constants.HIBERNATE_JDBC_LOB_NON_CONTEXTUAL_CREATION, Constants.HIBERNATE_FLAG_TRUE);
